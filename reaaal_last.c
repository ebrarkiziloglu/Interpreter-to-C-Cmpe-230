...
char result[N] = "";
char definitionBlock[5*N] = "";
char executableBlock[5*N] = "";
...
//                return 0;
    ...
    strcat(result, definitionBlock);
    strcat(result, executableBlock);
    printf("%s\n", result);
//    printf("CFile is:\n%s\n", cfile);
    return(0);
}
        ...
        if(strcmp(stacktokens[stackcur] , "*") == 0){
            ...
            if(type == 1 || type == 5 || type == 7){
                ...
                if(strcmp(temp, "") != 0) {
                    ...
                    strcpy(temp, stacktokens[stackcur]);
                }
            }
        }
            // id    //    id[]    // id[][]
