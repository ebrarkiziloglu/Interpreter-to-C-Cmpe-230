...
int process(char *str, int numTokens, char *res){
    ...
    // for statement:
        ...
        if(strcmp(tokens[cur],",")==0){
            ...
            cur = commaIndex+1;
            isInForLoop1 = true;
	    processStack(str1, processStr1, "");
	    processStack(str2, processStr2, "");
	    processStack(str3, processStr3, "");
            ...
            cur++;
            isInForLoop2 = true;
            processStack(str4, processStr4, "");
	    processStack(str5, processStr5, "");
            processStack(str6, processStr6, "");
            strcat(res, "for(int ");
